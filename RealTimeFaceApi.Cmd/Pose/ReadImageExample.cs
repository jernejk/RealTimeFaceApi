...
using System;
using System.IO;
using RealTimeFaceApi.Cmd.Pose.PoseNet;
...
public class ReadImageExample {
    ...
    public void Start () {
        ...
        graphModel = File.ReadAllBytes("Data/frozen_model.bytes");
		graph = new TFGraph ();
        ...
        //byte[] image = File.ReadAllBytes("Data/tennis_in_crowd.jpg");
        //var tensor = TransformInput(image, ImageSize, ImageSize);
        var tensor = ImageUtil.CreateTensorFromImageFile("Data/tennis_in_crowd.jpg");
    ...
    public PoseNet.Pose[] FindPose(byte[] image)
    {
